...
-- Se crea procedimiento para visualizar el consumo de una Reserva
create procedure VENTAS.uspVisualizarConsumo
	@CReserva int
	as begin
select * from vw_monto_total as vw
where vw.CReserva = @CReserva
end

exec ventas.uspVisualizarConsumo 1
